        ...
        <div class="back-main-menu">
            <nav>
                ...
                <div class="menu-toggle">
                    <div class="logo"><a href="index-2.html" class="logo-text"> <img class="back-logo-dark"
                                src="{{ asset('theme/client/assets/images/logo.png') }}" alt="logo"> <img
                                class="back-logo-light" src="{{ asset('theme/client/assets/images/light-logo.png') }}"
                                alt="logo"> </a></div>
                    ...
                    <div class="searchbar-part back-search-desktop">
                        <ul>
                            <li class="back-dark-light"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-sun back-go-light">
                                    <circle cx="12" cy="12" r="5"></circle>
                                    <line x1="12" y1="1" x2="12" y2="3"></line>
                                    <line x1="12" y1="21" x2="12" y2="23"></line>
                                    <line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line>
                            ...
                            <li class="back_search"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <form class="search-form" action="{{route('search')}}" method="GET">
                            @csrf
                            <input type="text" name="blog"  class="form-input" placeholder="Search Here ">
