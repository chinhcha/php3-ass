...
<div class="back-canvas">
    ...
    <div class="offback-logo">
        <a href="index-2.html" class="logo-text"> <img src="{{ asset('theme/client/assets/images/logo.png')}}" alt="logo"></a>
    </div>
...
<div id="back__preloader">
    ...
    <div class="back__loader_logo"><img src="{{ asset('theme/client/assets/images/preload.png')}}" alt="Preload"></div>
</div>
