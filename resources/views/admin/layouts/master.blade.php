                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">a
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">
                                                    ...
                                                    <label class="form-check-label" for="messages-noatification-check04"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">a
                                    <li class="nav-item">
                                            ...
                                            <div class="acitivity-timeline acitivity-main">
                                                <div class="acitivity-item d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-1">Product noise evolve smartwatch </p>a
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0 text-muted"><small>9:47 PM Yesterday</small></p>a
                                                    </div>
                                                </div>
                                                <div class="acitivity-item py-3 d-flex">
                                                    <div class="flex-shrink-0">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <small class="mb-0 text-muted">12 Dec, 2021</small>a
                                                    </div>
                                                </div>
                                                <div class="acitivity-item py-3 d-flex">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="row align-items-center g-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="p-1">
                                                            <div class="progress animated-progress progress-sm">a
    ...
    <script src="{{ asset('theme/admin/assets/libs/jsvectormap/maps/world-merc.js')}}"></script>a
