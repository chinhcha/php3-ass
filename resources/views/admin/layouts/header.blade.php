                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="{{ route('admin.home') }}" class="btn btn-soft-secondary btn-sm rounded-pill">how to setup
                                    <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="{{ route('admin.home') }}" class="btn btn-soft-secondary btn-sm rounded-pill">buttons <i
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset('theme/admin/assets/images/users/c.jpg') }}"
                                 alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Hello</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"> {{Auth::user()->name}}</span>
                            </span>
                        </span>
                    </button>
