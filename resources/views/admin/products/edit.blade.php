                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Edit New File</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.products.update',$post->id) }}" method="POST"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea class="form-control" name="content" id="content" rows="3"  placeholder="Enter description">{{$post->title}}</textarea>
                                        </div><!--end col-->
                                        <div class="col-lg-12">
                                            ...
                                            <input type="file" class="filepond filepond-input-multiple" multiple
                                                ...
                                                data-max-files="2">
                                            <img src="{{\Illuminate\Support\Facades\Storage::url($post->image)}}"  alt="" width="100px">

                                        </div><!--end col-->

                                        <div class="col-lg-4">
                                            <label for="itemPrice" class="form-label">Views</label>
                                            <input type="text" class="form-control" name="views" {{$post->views}} id="views" placeholder="Views">
                                        </div><!--end col-->
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control" name="category_id" id="category_id">
                                                ...
                                                <option value="{{$data->id}}" @selected($post->category_id == $data->id )>{{$data->name}}</option>
                                            @endforeach
                                            </select>
                                        </div><!--end col-->
                                        <div class="col-lg-12">
